    ...
    override func spec() {
        describe("AppCoordinator") {
            ...
            beforeEach {
                ...
                tabController = rootController as? UITabBarController
            }

            context("rootViewController") {
                it("should have tab bar controller as root controller") {
                    expect(rootController).to(beAKindOf(UITabBarController.self))
                }
            }
